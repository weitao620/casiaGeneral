        ...
        <div class="group-class">
            ...
            <div class="group_box" id="overviewpage">
                <div id="viewImage1">
                    ...
                    <div class="fuck yy_box mulu_empty_page">
                        <div class="noSplitBox" style="padding-bottom: 600px;">
                            ...
                            <div class="yy_txt noSplitBox">
                                <!-- {{version == '81' ? '初中一年级直升班与非直升班各维度检出率、' : ''}} -->
                ...
                <div class="yy_box basic_box" id="viewImage3">
                    ...
                    <div class="yy_txt noSplitBox" style="margin-bottom: 10px;">
                    ...
                    <div v-for="(item, index) in gradeAllList" :key="index">
                        ...
                        <!-- v-if="item.name.indexOf('初中') == -1 && item.gradeObj" -->
...
export default {
    ...
    computed: {
        schoolPdfs1() {
            console.log(this.$store.state.schoolFlag)
    ...
    methods: {
        ...
        schoolSub() {
            ...
            // let param = {
            //     // organization: this.partsForm1.organization,
            //     // organizationName: this.organizationName,
            //     startDate: star,
            //     endDate: end,
            //     code: '',
            //     gender: 1,
            //     // type: that.partsForm1.type == 2 ? Number(1) : Number(0),
            ...
            this.$http
                ...
                .then(res => {
                    ...
                    if (res.data.code == 0) {
                        ...
                        gradeListTain = gradeListTain.concat(gradeListTain).concat(gradeListTain)
                        console.log(this.gradeAllList)
                        for (let i in this.gradeAllList) {
