                ...
                <div class="yy_box basic_box" style="padding: 0 70px 20px;">
                    ...
                    <table cellspacing="0" style="margin-bottom: 0;">
                        ...
                        <tr v-for="(itemr, indexr) in item.reportInfoList" :key="indexr"
                            ...
                            <td>{{ itemr.accountState == 1 ? '是' : '否'}}</td>
...
const Urls = 'http://36.110.172.217:11008'
...
export default {
    ...
    methods: {
        ...
        partsSub() {
            ...
            this.$http
                .post(Urls + "/aimw/export/dimensionProportion", param1)
                .then(res => {
            ...
            this.$http
                .post(Urls + "/aimw/export/exportGradeInfoByOrgIdAndDate", param2)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/exportHealthInfoByOrgIdAndDate", param3)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        this.part3 = true;
            ...
            this.$http
                .post(Urls + "/aimw/export/genderDimensionProportion", param4)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        let man = []
            ...
            this.$http
                .post(Urls + "/aimw/export/genderGroupHealthInfo", param5)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        this.part5 = true;
            ...
            this.$http
                .post(Urls + "/aimw/export/gradeGroupHealthInfo", param8)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            // };
            // this.$http
            //     .post(Urls + "/aimw/export/serverCrowdList", paramnan)
            //     .then(res => {
            //         let data = res.data.data;
            //         if (res.data.code == 0) {
            //             console.log('直升')
            ...
            // };
            // this.$http
            //     .post(Urls + "/aimw/export/serverCrowdList", paramnv)
            //     .then(res => {
            //         let data = res.data.data;
            //         if (res.data.code == 0) {
            //             console.log('非直升')
            ...
            // };
            // this.$http
            //     .post(Urls + "/aimw/export/serverCrowdList", param9)
            //     .then(res => {
            //         let data = res.data.data;
            //         if (res.data.code == 0) {
            //             this.part9 = true;
        ...
        getDim(param7, star, end) {
            this.$http
                .post(Urls + "/aimw/export/gradeDimensionProportion", param7)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        let gradeWd = []
        ...
        getDim6(param6) {
            this.$http
                .post(Urls + "/aimw/export/gradeClassDimensionProportion", param6)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        let xList = {
        ...
        genderQuestion(star, end) {
            ...
            this.$http
                .post(Urls + "/aimw/export/dimensionProportion", param91)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/dimensionProportion", param92)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/serverCrowdList", param10)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/dimensionProportion", param101)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/dimensionProportion", param102)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/serverCrowdList", param11)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            // this.$http
            //     .post(Urls + "/aimw/export/serverCrowdList", param12)
            //     .then(res => {
            //         let data = res.data.data;
            //         if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/dimensionProportion", param121)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/dimensionProportion", param122)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            // this.$http
            //     .post(Urls + "/aimw/export/serverCrowdList", param13)
            //     .then(res => {
            //         let data = res.data.data;
            //         if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/dimensionProportion", param131)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/dimensionProportion", param132)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/classicCaseList", param140)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/classicCaseList", param141)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/classicCaseList", param142)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/classicCaseList", param143)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/classicCaseList", param144)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
            ...
            this.$http
                .post(Urls + "/aimw/export/classicCaseList", param145)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
