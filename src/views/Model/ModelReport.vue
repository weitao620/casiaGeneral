  ...
  <div class="table-class" ref="sprintReportPerson">
    <div class="table-style group_01">
      ...
      <div class="gp_01_box">
        <div class="gp_01_photo">
          <img src="../../assets/images/model/nan.png" v-if="gender == 1" alt="">
          <img src="../../assets/images/model/nv.png" v-else alt="">
        </div>
        <div class="gp_01_msg">
          <ul>
            <li>
    ...
    <div class="table-style group_02">
      ...
      <div class="gp2_box">
        ...
        <p style="font-weight: 900;font-size: 22px; margin-top: 20px;padding: 0px 0">
          【报告内容说明】
        </p>
        <p>
          ...
          <div v-if="index === 0">
            ...
            <div class="dtmsb_tar">
              <div style="position:relative">
                ...
                <div v-if="item.title == '心理韧性' && index == 0" id="myChartLd22" class="myChartLd11" ref="myChartLd22" style="height:246px"></div>
                <div v-if="item.title == '心理韧性' && index == 1" id="myChartLd33" class="myChartLd11" ref="myChartLd33" style="height:246px"></div>
                <div v-if="item.title == 'PTSD' && index == 0" id="myChartLd22" class="myChartLd11" ref="myChartLd22" style="height:246px"></div>
                <div v-if="item.title == 'PTSD' && index == 1" id="myChartLd33" class="myChartLd11" ref="myChartLd33" style="height:246px"></div>
              </div>
              <!-- <ul class="dtmsb_ulc">
                <li>
                  <img src="../../assets/images/report/fwLine.png" alt="" />
...
export default {
  ...
  methods: {
    ...
    initEchart() {
      ...
      setTimeout(() => {
        var theIndex = -1;
        this.myChartRose1 = echarts.init(this.$refs.myChartRose1);
        ...
        this.myChartZhu1 = echarts.init(this.$refs.myChartZhu1);
...
.group_03{
  ...
  .gp3_box{
    ...
    .wdrj_main {
      padding: 30px 30px;
      background: #ffffff;
      box-shadow: 0 13px 43px 0 rgba(70, 101, 135, 0.04);
      border-radius: 4px;
      margin-bottom: 40px;
      .wdrj_title {
        display: flex;
...
.group_05{
  ...
  .gp5_img_ul{
    ...
    .gp5_img_li{
      ...
      box-shadow: 0px 3px 13px 0px rgba(87, 139, 215, 0.1);
      border-radius: 4px;
      margin-bottom: 40px;
      img{
        width: 100%;
...
.group_06{
  ...
  .dtmt_tle{
    ...
    label{
      ...
      width: 4px;
      height: 18px;
      background: linear-gradient(180deg, #2D76F6 0%, #53C0F9 100%);
      margin-right: 6px;
    }
    span{
      font-size: 20px;
