<template>
    <div>
        <div class="group-class">
            ...
            <div class="group_box" id="dstrictOverviewpage">
                <div id="viewImage1">
                    <!-- 封面 -->
                    <div class="group_style">
                        ...
                        <div class="table-border noSplitBox">
                            <div class="g1_top">
                                <span>{{parentName}}{{ schoolName }}</span>
                            </div>
                            <div class="g1_top1">
                                {{ reportName1 }}
                            </div>
                    ...
                    <div class="fuck yy_box yy_boxs">
                        <div class="noSplitBox" style="height: 1640px;">
                            ...
                            <div class="yy_txt">
                                近年来，学生心理健康问题日益严峻，焦虑、抑郁、自杀倾向等情况上升，已成为影响青少年成长的重要因素。政府高度重视，出台《教育强国建设规划纲要（2024—2035年）》等政策，要求建立心理健康监测和预警体系。传统心理测评方式因覆盖面有限、筛查效率低、学生主观影响大，难以精准识别心理问题。本次筛查项目依托“AI态势感知”智能平台，通过AI沙盘测评、大数据分析、智能预警等技术，提高筛查效率，实现早发现、早干预，助力构建全省心理健康保障体系。本次心理健康筛查项目严格依据《全面加强和改进新时代学生心理健康工作专项行动计划（2023—2025年）》的要求，在各地建立心理健康监测与预警系统，加强数据化管理，并分学段完善心理服务机制。按照此要求，江西省采用“AI心世界”心理健康态势感知平台，利用人工智能、大数据分析技术，实现心理健康筛查、风险预警、干预指导的全流程智能化管理，确保学生心理问题能够被及时发现和跟进处理。
                            </div>
                            <div class="yy_t mulu_page">
                                1.2 测评目的
                            </div>
                ...
                <div class="yy_box basic_box" id="viewImage2">
                    <div class="noSplitBox">
                        ...
                        <div class="yy_txt">
                            {{ schoolName }}对{{ detail.totalClasses }}个学校共{{ detail.totalStudents
                        ...
                        <div style="width: 100%;height: auto;">
                            <div style="width: 100%;height: 300px;margin: 0 auto;" class="myChart" ref="myChart1">
                            </div>
                        ...
                        <div style="width: 100%;height: auto;margin: 20px auto 10px;">
                            <div style="width: 100%;height: 300px;margin: 0 auto;" class="myChart" ref="myChart2">
                                学段--饼状图</div>
                    ...
                    <div class="noSplitBox">
                        ...
                        <div class="yy_txt">
                            本次筛查评估内容包括学生的心理健康风险水平和心理健康问题两大方面。测评结果仅供参考，不作为诊断使用
                        </div>
                        <div class="yy_t  mulu_page">
                            2.1.2.1 心理健康风险水平
                        </div>
                        ...
                        <table cellspacing="0">
                            <tr class="pdf-details" style="background: #e9e9e9">
                                <th style="width:160px">心理健康水平</th>
                                <th style="line-height: 32px;">内容</th>
                            </tr>
                            <tr v-for="(item, index) in oneData2" :key="index" class="pdf-details">
                                <td>{{ item.name }}</td>
                                <td style="text-align: left;line-height: 32px;">{{ item.content }}</td>
                            </tr>
                        </table>
                        ...
                        <div class="yy_biao" style="">
                            表 2 心理健康问题的筛查评估指标和解释
                        </div>
                        <table cellspacing="0">
                            <tr class="pdf-details" style="background: #e9e9e9">
                                <th style="width:160px">心理健康问题</th>
                                <th style="line-height: 32px;">内容</th>
                            </tr>
                ...
                <div class="yy_box basic_box" id="viewImage3">
                    <div class="noSplitBox">
                        ...
                        <table class="cm_table" cellspacing="0">
                            ...
                            <tr class="pdf-details">
                                <td>差值</td>
                                <td :class="{
                                    redc: Number(cmCha[0].num) > 0,
                                    bluec: Number(cmCha[0].num) < 0
                                }">{{ cmCha[0].num }}%</td>
                                <td :class="{
                                    redc: Number(cmCha[1].num) > 0,
                                    bluec: Number(cmCha[1].num) < 0
                                }">{{ cmCha[1].num }}%</td>
                                <td :class="{
                                    redc: Number(cmCha[2].num) > 0,
                                    bluec: Number(cmCha[2].num) < 0
                                }">{{ cmCha[2].num }}%</td>
                                <td :class="{
                                    redc: Number(cmCha[3].num) > 0,
                                    bluec: Number(cmCha[3].num) < 0
                                }">{{ cmCha[3].num }}%</td>
                                <td :class="{
                                    redc: Number(cmCha[4].num) > 0,
                                    bluec: Number(cmCha[4].num) < 0
                                }">{{ cmCha[4].num }}%</td>
                            </tr>
                            <tr class="pdf-details">
                                <td>{{ schoolName }}</td>
                    ...
                    <div class="noSplitBox">
                        <div style="width: 100%;height: auto;margin: 10px auto 0px;">
                            <div style="width: 75%;height: 240px;margin: 0 auto;" class="myChart" ref="myChart4">
                            </div>
                        </div>
                        <table class="cm_table" cellspacing="0" style="margin-bottom: 10px;">
                            ...
                            <tr class="pdf-details">
                                <td>
                                    <div style="display: flex;justify-content: center;align-items: center;"><span
                                            style="margin-right:6px; width: 10px;height: 10px;border-radius: 50%;background: #8ACBFF"></span><span style="font-size: 20px;font-family: SourceHanSansCN-Regular, SourceHanSansCN;font-weight: 400;color: #000000;">轻度问题</span>
                                    </div>
                                </td>
                            ...
                            <tr class="pdf-details">
                                <td>
                                    <div style="display: flex;justify-content: center;align-items: center;"><span
                                            style="margin-right:6px; width: 10px;height: 10px;border-radius: 50%;background: #FFDDA0"></span><span style="font-size: 20px;font-family: SourceHanSansCN-Regular, SourceHanSansCN;font-weight: 400;color: #000000;">中度问题</span>
                                    </div>
                                </td>
                            ...
                            <tr class="pdf-details">
                                <td>
                                    <div style="display: flex;justify-content: center;align-items: center;"><span
                                            style="margin-right:6px; width: 10px;height: 10px;border-radius: 50%;background: #FE9D9D"></span><span style="font-size: 20px;font-family: SourceHanSansCN-Regular, SourceHanSansCN;font-weight: 400;color: #000000;">重度问题</span>
                                    </div>
                                </td>
                    ...
                    <div class="noSplitBox">
                        ...
                        <div class="yy_biao" style="text-align: center;margin-top: -10px">注：加*表示该学段检出率同时高于全国常模和本区常模
                        </div>
                    ...
                    <div v-for="(item, index) in gradeAllList" :key="index">
                        ...
                        <div class="noSplitBox">
                            ...
                            <div class="legends" style="width: 100%;height: auto;margin: 10px auto 0px;">
                                <div style="width: 100%;height: 240px;margin: 0 auto;" class="myChart"
                        ...
                        <div v-for="(itemw, indexw) in item.wdList" :key="indexw">
                            ...
                            <div class="noSplitBox" style="width: 100%;height: auto;margin: 0px auto 0px;">
                                ...
                                <div style="display: flex; justify-content: space-between;">
                                    <div style="width: 100%;">
                                        <div style="width: 100%;height: 150px;margin: 0 auto;" class="myChart"
                                            :ref="'myChart2' + index + indexw"></div>
                                        <div class="rtr_ul">
                                            <ul>
                                                <li style="padding: 4px 20px 6px;"><span class="r_cir1"></span>{{ itemw.name }}</li>
                                                <li style="padding: 4px 20px 6px;"><span class="r_line1"></span>全国常模</li>
                                                <li style="padding: 4px 20px 6px;"><span class="r_line2"></span>学段常模</li>
                                            </ul>
                                        </div>
                                    ...
                                    <!-- <div style="width: 520px;">
                                        ...
                                        <table cellspacing="0" style="width: 100%;">
                                            ...
                                            <tr class="pdf-details">
                                                <td style="width: 130px;">高于全国常模和学段常模</td>
                                                <td v-if="item.cwdName" style="line-height: 22px;">
                                        ...
                                        <div class="yy_biao"
                                            ...
                                            注：加*表示该班检出率同时高于全国常模和学段常模</div>
                                    </div> -->
                                </div>
                            </div>
                        </div>
                        <!-- <div class="yy_t noSplitBox" style="text-align: center;margin: 0px 0 5px;font-size: 20px;">
                            {{ item.name }}各维度重点关注班级
                        </div>
                        <table cellspacing="0">
                            <tr class="pdf-details noSplitBox" style="background: #e9e9e9">
                            ...
                            <tr class="pdf-details noSplitBox" style="border-top: 0;height: 40px;" v-if="item.csListz.length == 0">
                                <td colspan="6">无</td>
                            </tr>
                        ...
                        <div class="noSplitBox" style="width: 100%;height: auto;margin: 0px auto ;">
                            ...
                            <div style="width: 100%;height: 400px;margin: 0 auto;" class="myChart"
                        ...
                        <div class="yy_t mulu_page">
                            3.{{ index + 2 }}.4 {{ item.name }}学段典型案例
                        </div>
                        <div class="yy_txt noSplitBox" v-if="item.gradeObj">
                            <div class="caseWorks"  v-if="item.gradeObj.view_path">
                                <div class="yy_t">【案例作品】</div>
                                <div style="margin: 10px 0;"><img :src="getImageSrc(item.gradeObj.view_path)" alt=""></div>
                            </div>
                            <div class="overallAssessment"  v-if="item.gradeObj.dimensionsInfo && item.gradeObj.dimensionsInfo.length > 0">
                                <div class="yy_t">【总体评估】</div>
                                <div class="yy_t item" v-for="(dimension,index0) in item.gradeObj.dimensionsInfo" :key="index0">
                                    <div class="black_round"></div>{{dimension.name}}:{{dimension.lvName}}
                                </div>
                            </div>
                            <div class="dimensionalAnalysis"   v-if="item.gradeObj.dimensionsInfo && item.gradeObj.dimensionsInfo.length > 0">
                                <div class="yy_t">【维度分析】</div>
                                <div class="yy_t item" v-for="(dimension,index1) in item.gradeObj.dimensionsInfo" :key="index1">
                                    <div class="yy_txt">{{index1 + 1}}.{{dimension.name}}</div>
                                    <div class="yy_txt"  v-for="(textItem,index2) in dimension.textArr" :key="index2">
                                        （{{index2 + 1}}）{{textItem}}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="yy_t mulu_page">
                            3.{{ index + 2 }}.5 {{ item.name }}学段测评总结
                        </div>
                        <div class="yy_txt">总的来说，小学阶段的学生焦虑问题最为普遍。小学生处于心理发展的重要阶段，面临着多种挑战和压力。随着学业竞争的加剧，很多孩子面临着沉重的学习负担和家长、老师的高期望，这容易导致孩子产生焦虑情绪。他们可能会表现出对学习的厌倦、不愿意上学、对考试的极度紧张、失眠等。这些问题不仅影响孩子的学习积极性，还可能导致他们在人际交往中显得退缩，不愿与同学交流，甚至影响与父母的关系，变得疏远或不信任。</div>
                        <div class="yy_txt">针对这些高发心理问题，家长和老师应合理调整对孩子的期望值，鼓励他们采取积极的学习态度，建立合理的学习计划，并给予积极的肯定和鼓励，帮助孩子认识到自己的优点和进步。同时，通过开展集体活动，提升孩子的社交技能，增强他们的自信心。对于分离焦虑等问题，家长可以逐渐让孩子适应与父母分离的情境，鼓励他们独立，帮助他们克服焦虑情绪。</div>
...
export default {
    ...
    computed: {
        schoolPdfs1() {
            return this.$store.state.dstrictFlag;
        },
        bindmodel() {
    ...
    watch: {
        schoolPdfs1: function(newVal, oldVal) {
            ...
            if (newVal) {
                ...
                this.$http
                    .post(Url + "/aimw/countyExport/gradeDimensionProportion", param7)
                    .then(res => {
                        ...
                        if (res.data.code == 0) {
                            ...
                            data = data.sort((a, b) => {
                                return Number(a.department) - Number(b.department);
                            })
                            console.log(data)
                            let muluArr = []
                            this.muluList = [
                            ...
                            for (let i in data) {
                                let gArr = {
                                    id: Number(i) + 2,
                                    name: data[i].departmentName + '测评分析',
                                    page: '',
                                    mark: 2,
                                    list: [
                                        {
                                            id: 1,
                                            name: data[i].departmentName + '测评结果概况',
                                            page: '',
                                            mark: 3
                                        },
                                        {
                                            id: 2,
                                            name: data[i].departmentName + '各维度检出率情况',
                                            page: '',
                                            mark: 3,
                                            list: [
                                                {
                                        ...
                                        {
                                            id: 3,
                                            name: data[i].departmentName + '不同性别测评情况',
                                            page: '',
                                            mark: 3
                                        },
                                        {
                                            id: 4,
                                            name: data[i].departmentName + '重点关注人员名单',
                                            page: '',
                                            mark: 3
                                        }
                                    ]
    ...
    methods: {
        ...
        echartInit() {
            ...
            this.myChart1.setOption({
                color:['#FFDDA0','#94EC9E','#9C8BFF','#6FBFFF','#FF99C8','#FF8D6F','#9291A5','#336FFF','#CCDBFF','#FF4B6A','#87EDE6','#FF33E3'],
                tooltip: {
                    trigger: "item"
                },
                legend: {
            ...
            for (let i in this.gradeAllList) {
                ...
                for (let j in wdList) {
                    ...
                    let min2max = 0
                    if (Number(wdList[j].percent) > Number(this.ChinaCM[j])) {
                        if (Number(wdList[j].percent) < 90) {
                            min2max = Number(wdList[j].percent) + 10
                        } else {
                            min2max = Number(wdList[j].percent)
                        }
                        
                    } else {
                        min2max =  Number(this.ChinaCM[j]) + 10
                    }
        ...
        schoolSub() {
            ...
            this.parentName =  this.sList.parentName
            ...
            this.$http
                .post(Url + "/aimw/countyExport/dimensionProportion", param1)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        let wdJcList = [
                        ...
                        if (c3 == 5) {
                            ...
                            cmTxt += '与全国常模相比，学生整体各维度检出率都高于全国常模，心理健康问题有待改善，'
                            let cmChaArr = []
                            ...
                            if (cmChaArr.length < 5) {
                                cmTxt += '其中，' + cmChaArr.join('、') + '维度' + cmChaArr.length > 1 ? '皆' : '' + '超出全国常模' + cmChaSort[0].num + '%。'
                            } else {
                        ...
                        if (c1 == 5) {
                            ...
                            // cmTxt += '各维度皆低于全国常模**%。'
                            cmTxt += '与全国常模相比，学生整体各维度都低于全国常模，心理健康问题总体表现较好，'
                            let cmChaArr1 = []
                            for (let i in cmChaSort) {
                                if (cmChaSort[i].num == cmChaSort[4].num) {
                            ...
                            if (cmChaArr1.length < 5) {
                                cmTxt += '其中，' + cmChaArr1.reverse().join('、') + '问题相对较小，' + cmChaArr1.length > 1 ? '皆' : '' + '低于全国常模' + cmChaSort[0].num + '%。'
                            } else {
                                cmTxt += '各维度皆低于全国常模' + cmChaSort[4].num + '%。'
                            }
                        ...
                        console.log(wdNum)
                        console.log(111111111111111111111,wdArrNum)
                        ...
                        if (wdNumNo.length == 5) {
                            ...
                            wdpStr += '综上所述，' + wdArrNum[0].name + '问题是学生最突出的心理健康问题，其次为' + wdArrNum[1].name + '问题。学校和家长应当对此给予高度重视，采取相应的预防和干预措施，以保障学生的心理健康。'
                            wdpStr += '</div>'
                            ...
                            wdpStr += '<div class="yy_txt">'
                            wdpStr += '综上所述，' + wdp1 + '问题是学生最突出的心理健康问题，' + wdp2 + '问题相对较少。学校和家长应当对此给予高度重视，采取相应的预防和干预措施，以保障学生的心理健康。'
                            wdpStr += '</div>'
                        } else {
                            // C.若检出率有3-4个数值不同：
                            if (wdNumNo.length == 3) { // 13344 11134
                                ...
                                wdpStr += '</div>'
                                wdpStr += '<div class="yy_txt">'
                                wdpStr += '综上所述，' + wdp31 + '问题是学生最突出的心理健康问题，其次为' + wdp32 + '问题。学校和家长应当对此给予高度重视，采取相应的预防和干预措施，以保障学生的心理健康。'
                                wdpStr += '</div>'
                            }
            ...
            this.$http
                .post(Url + "/aimw/countyExport/exportGradeInfoByOrgIdAndDate", param2)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        // data.gradeList = data.gradeList.sort((a, b) => {
                        //     return Number(a.orgId) - Number(b.orgId);
                        // })
                        data.schoolList = data.schoolList.sort((a, b) => {
                        ...
                        for (let i in schoolList) {
                            ...
                            schoolList[i].percent = ((schoolList[i].userStudent / data.totalStudents) * 100).toFixed(1)
                        ...
                        let gArr2 = []
                        for ( let i in data.schoolList) {
                            gArr2.push(data.schoolList[i].grade + '学生' + data.schoolList[i].userStudent +'个')
                        }
                        ...
                        let gArr12 = []
                        for ( let i in data.schoolList) {
                            gArr12.push(data.schoolList[i].grade + data.schoolList[i].userStudent +'人（占比' +data.schoolList[i].percent +'%）')
                        }
            ...
            this.$http
                .post(Url + "/aimw/countyExport/exportHealthInfoByOrgIdAndDate", param3)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        console.log('无用接口')
            ...
            this.$http
                .post(Url + "/aimw/countyExport/genderDimensionProportion", param4)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        let man = []
            ...
            this.$http
                .post(Url + "/aimw/countyExport/genderGroupHealthInfo", param5)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        console.log('无用接口')
            ...
            this.$http
                .post(Url + "/aimw/countyExport/gradeGroupHealthInfo", param8)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        console.log('无用接口')
                    ...
                    if (res.data.code == 0) {
                        ...
                        if (a1) { //若各个学段各维度检出率完全一致
                            ...
                            if (count > 2) {
                                ...
                                // 若各个学段检出率不完全一致，由高到低前三位维度中有相同维度（相同维度数=2），则按学段由低到高相应输出：
                                aTxt2 += sName.join('、')
                                ...
                                // 若各个学段检出率不完全一致，由高到低前三位维度中相同维度数为0，则按学段由低到高相应输出：
                        ...
                        // 预备学段测评维度检出率由高到低分别为：焦虑（36.1%）、抑郁（23.0%）、敌对（21.6%）、自我伤害（17.4%）、强迫（17.2%）；初中一学段测评维度检出率由高到低分别为：焦虑（28.0%）、抑郁（24.4%）、自我伤害（20.2%）、敌对（16.1%）、强迫（15.4%）；高中一学段测评维度检出率由高到低分别为：焦虑（31.9%）、抑郁（24.3%）、自我伤害（20.7%）、强迫（18.8%）、敌对（18.6%）。
                        ...
                        // 与全国常模相比，预备学段/**学段学生（第一句）在强迫、自我伤害方面表现较好，（第二句：在**方面与全国常模持平，）（第三句）在敌对、抑郁和焦虑方面有待改善，分别超出全国常模 6.3%、 3.1%。
                        // 与全国常模相比，初中一学段学生（第一句）在强迫、自我伤害、敌对和焦虑方面表现较好。（第二句：在**方面与全国常模持平，）(第三句）在抑郁方面有待改善，超出全国常模 4.5%。
                        for (let i in this.gradeAllList) {
                            ...
                            if (allCont0 == 5) { //都大于全国
                                ...
                                allTxt += '在抑郁、焦虑、强迫、敌对、自我伤害方面都与全国常模持平，本学段心理健康问题与全国状况大致相当。'
                                ...
                                if (d0.length > 1) {
                                    allTxt += '在' + d0.join('、') + '在方面有待改善，分别超出全国常模' + d01.join('、') + '。'
                                } else {
                                    allTxt += '在' + d0.join('、') + '在方面有待改善，超出全国常模' + d01.join('、') + '。'
                                }
                        ...
                        for (let i in this.gradeAllList) {
                            ...
                            if (allCont0 == 5) { //都大于全国
                                allTxt += '在抑郁、焦虑、强迫、敌对、自我伤害方面均有待改善，其中，'
                                console.log(percentArr)
                                allTxt += percentArr[0].name + '、' + percentArr[1].name + '和' + percentArr[2].name + '超出本区常模相对较多，分别为' + percentArr[0].percentNo + '%、' + percentArr[1].percentNo + '%和' + percentArr[2].percentNo + '%。'
                            } else if (allCont1 == 5) { //都等于全国
                                allTxt += '在抑郁、焦虑、强迫、敌对、自我伤害方面都与本区常模持平，本学段心理健康问题与本校状况大致相当。'
                            } else if (allCont2 == 5) { //都小于全国
                                // allTxt += '在抑郁、焦虑、强迫、敌对、自我伤害方面均表现比较好，其中，**、**和**低于全国常模相对较多，分别为**%、**%和%。'
                                allTxt += '在抑郁、焦虑、强迫、敌对、自我伤害方面均表现比较好，其中，'

                                console.log(percentArr)
                                allTxt += percentArr[0].name + '、' + percentArr[1].name + '和' + percentArr[2].name + '低于本区常模相对较多，分别为' + percentArr[0].percentNo + '%、' + percentArr[1].percentNo + '%和' + percentArr[2].percentNo + '%。'
                            } else {
                                let d0 = [] //高
                                let d01 = [] //高
                                let d1 = [] //等于
                                ...
                                if (d0.length > 1) {
                                    allTxt += '在' + d0.join('、') + '在方面有待改善，分别超出本区常模' + d01.join('、') + '。'
                                } else {
                                    allTxt += '在' + d0.join('、') + '在方面有待改善，超出本区常模' + d01.join('、') + '。'
                                }
                        ...
                        console.log(this.gradeAllList)
                        // 各学段各班级各维度检出率情况(根据code X,C,G) 不需要男女之分
                        let param6 = {
                            startDate: star,
                            endDate: end,
                            id: this.sList.schoolId
        ...
        getDim6(param6) {
            this.$http
                .post(Url + "/aimw/countyExport/gradeClassDimensionProportion", param6)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        data = data.sort((a, b) => {
                        ...
                        for(let i in this.gradeAllList) {
                            this.gradeAllList[i].csList =  this.gradeAllList[i].csList.sort((a, b) => {
                            return Number(a.department) - Number(b.department);
                        })
                        }
                        console.log(this.gradeAllList)
                        ...
                        for (let i in this.gradeAllList) {
                            ...
                            this.gradeAllList[i].className = [...new Set(this.gradeAllList[i].className)]
        ...
        genderQuestion(star, end) {
            ...
            this.$http
                .post(Url + "/aimw/countyExport/classicCaseList", param9)
                .then(res => {
                    let data = res.data.data;
                    if (res.data.code == 0) {
                        console.log('经典案例')
                        let arrData = JSON.parse(JSON.stringify(data))
                            for (let j in arrData){
                                const itemData = arrData[j]
                                arrData[j].clasName = arrData[j].classType == 1 ? '小学' : arrData[j].classType == 2 ? '初中' : arrData[j].classType == 3 ? '高中' : arrData[j].classType == 4 ? '高职' : arrData[j].classType == 5 ? '大学' : '';
                                let dimensionsInfo = []
                                if(arrData[j].anxiety_score > 1){
                                    let obj = {}
                                    obj.name = '焦虑'
                                    obj.lvName = this.getLvName(itemData.anxiety_score)
                                    obj.textArr = this.splitStringByDelimiter(itemData.anxiety_dim_analysis_manager)
                                    dimensionsInfo.push(obj)
                                }
                                if(arrData[j].depression_score > 1){
                                    let obj = {}
                                    obj.name = '抑郁'
                                    obj.lvName = this.getLvName(itemData.depression_score)
                                    obj.textArr = this.splitStringByDelimiter(itemData.anxiety_dim_analysis_manager)
                                    dimensionsInfo.push(obj)
                                }
                                if(arrData[j].forced_score > 1){
                                    let obj = {}
                                    obj.name = '强迫'
                                    obj.lvName = this.getLvName(itemData.forced_score)
                                    obj.textArr = this.splitStringByDelimiter(itemData.anxiety_dim_analysis_manager)
                                    dimensionsInfo.push(obj)
                                }
                                if(arrData[j].suicide_score > 1){
                                    let obj = {}
                                    obj.name = '自我伤害'
                                    obj.lvName = this.getLvName(itemData.suicide_score)
                                    obj.textArr = this.splitStringByDelimiter(itemData.anxiety_dim_analysis_manager)
                                    dimensionsInfo.push(obj)
                                }
                                if(arrData[j].violence_score > 1){
                                    let obj = {}
                                    obj.name = '敌对'
                                    obj.lvName = this.getLvName(itemData.violence_score)
                                    obj.textArr = this.splitStringByDelimiter(itemData.anxiety_dim_analysis_manager)
                                    dimensionsInfo.push(obj)
                                }
                                arrData[j].dimensionsInfo = dimensionsInfo
                            }

                        for (let i in this.gradeAllList) {
                            for (let j in arrData){
                                if (arrData[j].clasName == this.gradeAllList[i].name) {
                                    this.gradeAllList[i].gradeObj = arrData[j]
                                }
                            }
            ...
            for (let i in this.gradeAllList) {
                ...
                this.$http
                    .post(Url + "/aimw/countyExport/dimensionProportion", paramNan)
                    .then(res => {
                        let data = res.data.data;
                        if (res.data.code == 0) {
                            console.log('预备学段--男：' + data)
                            console.log(data)
                            if (data.length == 0) {
                                data = [
                                    {
                ...
                this.$http
                    .post(Url + "/aimw/countyExport/dimensionProportion", paramNv)
                    .then(res => {
                        let data = res.data.data;
                        if (res.data.code == 0) {
                            // console.log('预备学段--女：' + data)
                            // console.log(data)
                            if (data.length == 0) {
                                data = [
                                    {
        ...
        handleExport() {
            let pdf = new PdfLoader(
                document.querySelector("#dstrictOverviewpage"),
                this.parentName + this.schoolName + "中小学生心理健康筛查评估报告",
                "noSplitBox",
                this.loading,
                1
